...
#[test_only]
module mys::zklogin_verified_issuer_tests {
    use mys::zklogin_verified_issuer::{check_zklogin_issuer, delete, verify_zklogin_issuer, VerifiedIssuer};
    ...
    #[test]
    #[expected_failure(abort_code = mys::zklogin_verified_issuer::EInvalidProof)]
