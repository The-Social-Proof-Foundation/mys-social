...
module mys::kiosk_borrow_tests {
    use mys::kiosk_test_utils::{Self as utils, Asset};
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::ENotOwner)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EItemIsListed)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EWrongKiosk)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EItemMismatch)]
