...
module mys::kiosk_tests {
    use mys::kiosk_test_utils::{Self as test, Asset};
    use mys::mys::MYS;
    use mys::coin;
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EItemLocked)]
    ...
    fun test_purchase() {
        ...
        let payment = coin::mint_for_testing<MYS>(AMT, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::ENotListed)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EListedExclusively)]
    ...
    #[allow(unused_field)]
    public struct WrongAsset has key, store { id: mys::object::UID }

    #[test]
    #[expected_failure(abort_code = mys::kiosk::EItemNotFound)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EIncorrectAmount)]
    fun test_purchase_wrong_amount() {
        ...
        kiosk.place_and_list(&owner_cap, asset, AMT);
        let payment = coin::mint_for_testing<MYS>(AMT + 1, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::EAlreadyListed)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::ENotEmpty)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::kiosk::ENotEnough)]
    ...
    fun test_uid_access() {
        ...
        let uid = kiosk.uid();
        assert!(mys::object::uid_to_inner(uid) == mys::object::id(&kiosk));

        test::return_kiosk(kiosk, owner_cap, ctx);
    }

    #[test]
    #[expected_failure(abort_code = mys::kiosk::EUidAccessNotAllowed)]
