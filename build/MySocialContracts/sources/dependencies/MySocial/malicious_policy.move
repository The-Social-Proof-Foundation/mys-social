...
#[test_only]
module mys::malicious_policy {
    use mys::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module mys::transfer_policy_tests {
    use mys::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    use mys::dummy_policy;
    use mys::malicious_policy;
    use mys::package;
    use mys::coin;
    ...
    #[test]
    #[expected_failure(abort_code = mys::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::transfer_policy::EIllegalRule)]
