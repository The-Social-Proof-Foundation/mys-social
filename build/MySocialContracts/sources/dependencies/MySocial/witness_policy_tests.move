...
#[test_only]
module mys::witness_policy_tests {
    use mys::witness_policy;
    use mys::transfer_policy as policy;
    use mys::transfer_policy_tests::{
        Self as test,
        Asset
    };
    ...
    #[test]
    #[expected_failure(abort_code = mys::witness_policy::ERuleNotFound)]
