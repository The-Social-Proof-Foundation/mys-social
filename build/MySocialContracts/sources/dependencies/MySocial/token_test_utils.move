...
module mys::token_test_utils {
    use mys::coin::{Self, TreasuryCap};
    use mys::token::{Self, Token, TokenPolicy, TokenPolicyCap};
    ...
    public fun return_treasury_cap(treasury_cap: TreasuryCap<TEST>) {
        mys::transfer::public_share_object(treasury_cap)
    }
