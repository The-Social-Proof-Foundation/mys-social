...
#[test_only]
module mys::zklogin_verified_id_tests {
    use mys::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};
    use mys::test_scenario;

    #[test]
    #[expected_failure(abort_code = mys::zklogin_verified_id::EFunctionDisabled)]
