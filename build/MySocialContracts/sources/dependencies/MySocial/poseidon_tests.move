...
#[test_only]
module mys::poseidon_tests {
    use mys::poseidon::poseidon_bn254;
    ...
    #[test]
    #[expected_failure(abort_code = mys::poseidon::ENonCanonicalInput)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::poseidon::EEmptyInput)]
