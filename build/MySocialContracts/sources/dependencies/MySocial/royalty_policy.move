...
#[test_only]
module mys::royalty_policy_tests {
    use mys::coin;
    use mys::mys::MYS;
    use mys::royalty_policy;
    use mys::transfer_policy as policy;
    use mys::transfer_policy_tests as test;
    ...
    fun test_default_flow() {
        ...
        let mut payment = coin::mint_for_testing<MYS>(2000, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = mys::royalty_policy::EIncorrectArgument)]
    ...
    #[test]
    #[expected_failure(abort_code = mys::royalty_policy::EInsufficientAmount)]
    fun test_insufficient_amount() {
        ...
        let mut request = policy::new_request(test::fresh_id(ctx), 100_000, test::fresh_id(ctx));
        let mut payment = coin::mint_for_testing<MYS>(999, ctx);
