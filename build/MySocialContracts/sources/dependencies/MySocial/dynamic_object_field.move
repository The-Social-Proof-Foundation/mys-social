...
/// Similar to `mys::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `mys::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module mys::dynamic_object_field;
