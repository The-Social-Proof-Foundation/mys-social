...
#[test_only]
module mys::config_tests {

    use mys::config::{Self, Config};
    use mys::test_scenario as ts;
    ...
    fun config_create<WriteCap>(cap: &mut WriteCap, ctx: &mut TxContext) {
        mys::config::share(mys::config::new(cap, ctx))
    }
    ...
    #[test, expected_failure(abort_code = mys::config::EAlreadySetForEpoch)]
    ...
    #[test, expected_failure(abort_code = mys::config::ENotSetForEpoch)]
    ...
    #[test, expected_failure(abort_code = mys::dynamic_field::EFieldTypeMismatch)]
